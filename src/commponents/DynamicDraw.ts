...
*/
   ...
   * 动态编辑规则矩形(区域-2控制点)
   */
  editRectAnglePolygon(param: IEditParam): void {
    this.handlePlotEdit(param);
  }
  /**
   * 动态编辑三角形(区域-3控制点)
   ...
   * 动态编辑集结地(区域-3控制点)
   */
  editAssemblePolygon(param: IEditParam): void {
    this.handlePlotEdit(param);
  }
  /**
 * 动态编辑闭合曲面(区域-控制点无上限)
 */
  ...
  */
   ...
   * 动态编辑正圆(区域-2控制点)
   */
  editCircle(param: IEditParam): void {
    this.handlePlotEdit(param);
  }
  /**
   * 动态编辑椭圆(区域-2控制点)
   ...
   * 动态编辑曲形(线-控制点无上限)
   */
  editCurvePolyline(param: IEditParam): void {
    this.handlePlotEdit(param);
  }
  /**
   * 动态修改面 
