...
class ClosedCurvePolygon extends Polygon {
  ...
  constructor(coordinates: any, points: any, params: any) {
    super([]);
    this.type = EPlotType.ClosedCurvePolygon;
    this.t = 0.3;
  ...
  generate() {
    ...
    if (points === 2) {
      ...
      let normals: PlotUtils.Point[] = [];
      const pList: PlotUtils.Point[] = [];
...
export default ClosedCurvePolygon;
