import { Earth, animationTypes, lineStyles, measureTypes, shapeTypes, stylePresets, throttle, useEarth } from '@vrsim/earth-engine-ol';
...
if (lineStyles.polyline().linework === undefined || lineStyles.polygon().linework === undefined) throw new TypeError('lineStyles 根导出不可用');
