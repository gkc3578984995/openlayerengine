...
<template>
  <section :id="sectionId" class="doc-prose public-api-section">
    ...
    <article v-for="entry in selectedRuntime" :key="entry.anchor" class="public-api-section__entry">
    ...
    <article v-for="entry in selectedTypes" :key="entry.anchor" class="public-api-section__entry">
      <header :id="entry.anchor" class="public-api-section__entry-header">
      ...
      <div v-for="constructor in entry.constructors" :key="constructor.anchor" class="public-api-section__block">
        ...
        <div v-for="(signature, signatureIndex) in constructor.signatures" :id="signature.anchor" :key="signature.anchor" class="public-api-section__signature">
