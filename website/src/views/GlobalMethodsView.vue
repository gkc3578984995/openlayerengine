...
const methodRows = [
  ...
  { name: 'enableGraticule()', desc: '启用网格线控件', params: '—', returns: 'void' },
  { name: 'disableGraticule()', desc: '禁用网格线控件', params: '—', returns: 'void' },
  { name: 'enableScaleLine()', desc: '启用比例尺控件', params: '—', returns: 'void' },
    ...
    <article class="doc-page">
      ...
      <section id="demo" class="doc-prose">
        ...
        <div id="demo-controls">
          <ExampleBlock
            title="辅助控件"
            :description="`切换 <code class=&quot;code-fn-inline&quot;>enableGraticule</code> / <code class=&quot;code-fn-inline&quot;>enableScaleLine</code> 的开关。`"
